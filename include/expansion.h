...
void			cp_field(char *field, char *expand_str, char *quote_mask,
					size_t start, size_t end);
size_t			get_field_len(char *expand_str, char *quote_mask);
void			set_field(char **field, char *expand_str, char *quote_mask,
					size_t start, size_t end);
void			fill_fields(char **expand_strs, char **fields,
					char **quote_mask);
char			**filed_splitting(char **expand_strs, char **quote_mask);
